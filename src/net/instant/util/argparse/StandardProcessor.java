...
public abstract class StandardProcessor implements Processor {
    ...
    public StandardProcessor(String name, String help) {
        this.name = name;
        this.help = help;
        this.required = false;
    ...
    public StandardProcessor required() {
        setRequired(true);
        return this;
    }
    public StandardProcessor optional() {
        setRequired(false);
        return this;
    }
    ...
    public StandardProcessor withComment(String comment) {
